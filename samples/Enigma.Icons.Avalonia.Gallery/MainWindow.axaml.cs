...
/// The consequence, accepted for a sample: the XAML previewer cannot instantiate this window,
/// because there is no parameterless constructor and none will be added just to please the designer.
/// </remarks>
public partial class MainWindow : Window
{
    /// <summary>Creates the window and binds it to its ViewModel.</summary>
    /// <param name="viewModel">The gallery ViewModel.</param>
